 ...
 * "openrouter.ai" carries the CCCLAW app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__ccclawFetchPatched) return;
  globalThis.__ccclawFetchPatched = true;

  globalThis.fetch = function ccclawFetch(input, init) {
    var url =
