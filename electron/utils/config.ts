 ...
 */
export const PORTS = {
  /** CCCLAW GUI development server port */
  CCCLAW_DEV: 5173,
  
  /** CCCLAW GUI production port (for reference) */
  CCCLAW_GUI: 23333,

  /** Local host API server port */
  CCCLAW_HOST_API: 3211,
  
  /** CCCLAW Gateway port (different from OpenClaw's 18799 to avoid conflicts) */
  OPENCLAW_GATEWAY: 18799,
} as const;
...
export const APP_PATHS = {
  ...
  /** CCCLAW configuration directory */
  CCCLAW_CONFIG: '~/.ccclaw',
